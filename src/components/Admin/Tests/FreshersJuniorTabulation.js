...
function FreshersJuniorTabulation() {
    ...
    return (
        <div className="test-reports-container">
            <h1 style={{textAlign:'center'}}>Freshers Junior Test Tabulation Data</h1>
        ...
        {data.length >0  ? (
          data.map((item,index)=>
            ...
            <div className='table-data'>
              <p>{item.technical_score !==undefined ? "Technical Score" : (item.reasoning_score!==undefined ? 'Reasoning Score' : "React Score")}</p>
